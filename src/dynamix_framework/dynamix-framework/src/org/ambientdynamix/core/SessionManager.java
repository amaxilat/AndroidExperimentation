...
class SessionManager {
     ...
     *
     * @param app         the application to receive the event
     * @param contextType The context type that cannot be supported
     */
     ...
     * of the eventData.
     *
     * @param eventMap A Map containing DynamixSession entities and their associated SecuredEvents.
     */
    protected static void notifyContextListeners(final Map<IDynamixListener, List<ContextEvent>> eventMap) {
        ...
        broadcastHandler.post(new Runnable() {
            public void run() {
                ...
                IDynamixListener lastListener = null;
                ...
                for (int i = 0; i < N; i++) {
                    ...
                    final IDynamixListener listener = listeners.getBroadcastItem(i);
                    if (listener.equals(lastListener)) {
                        continue;
                    }
     ...
     *
     * @param app         the application to receive the event
     * @param plugin      The ContextPluginInformation handling the context support
     * @param supportInfo The ContextSupportInfo that was added.
     */
     ...
     * @param supportInfo The ContextSupportInfo that was removed.
     * @param contextType The context type of the support removed.
     */
     ...
     *
     * @param app    the application to receive the event
     * @param plugin Information about the ContextPlugin being installed
     */
     ...
     *
     * @param app             the application to receive the event
     * @param plugin          The ContextPluginInformation of the context plugin being installed to provide the context support.
     * @param contextDataType The context type of the support
     */
     ...
     *
     * @param app The Dynmaix app wishing to open a session
     ...
     *
     * @param app    The Dynmaix app wishing to open a session
     * @param notify True to notify sessions of close; false otherwise.
     ...
     *
     * @param listener The IDynamixListener to remove.
     */
     ...
     *
     * @param plug   The plug-in to remove context support from.
     ...
     *
     * @param session           The session to receive the IEventCommand
     * @param receivers         The list of receivers to receive the IEventCommand
     * @param eventCommand      The IEventCommand to send
     * @param receiversToRemove A list of receivers to remove after sending the IEventCommand
     */
