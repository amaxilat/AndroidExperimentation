...
public class PluginDetailsActivity extends Activity {
    ...
    protected void onResume() {
        ...
        if (extras != null) {
            ...
            ArrayList<FidelityDescription> descriptions = new ArrayList<>();
            ...
            if (plugin.isInstalled()) {
                ...
                if (plugin.hasConfigurationView()) {
                    if (DynamixService.isFrameworkStarted()) {
                        ...
                        btnConfigureContextPlugin.setText(R.string.configure_plugin);
                    } else {
                        btnConfigureContextPlugin.setEnabled(false);
                        btnConfigureContextPlugin.setText(R.string.configuration_offline);
                    }
                } else {
                    btnConfigureContextPlugin.setText(R.string.no_configuration);
                    btnConfigureContextPlugin.setEnabled(false);
                }
...
//							Utils.
    ...
    private class FidelityDescription {
        public final PrivacyRiskLevel level;
