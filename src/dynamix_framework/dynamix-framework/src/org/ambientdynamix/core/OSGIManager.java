...
class OSGIManager implements FrameworkListener, ServiceListener, BundleListener {
     ...
     *
     * @param androidContext The Android Context of the DynamixService.
     */
     ...
     * problems.
     *
     * @param bundleJar           The target Bundle JAR
     * @param replacementManifest The Bundle to inject into the bundleJar
     * @throws IOException
     */
     ...
     *
     * @param service The current DynamixService object.
     */
     ...
     *
     * @param plug The ContextPlugin's bundle to start. Returns true if the bundle was started; false, otherwise.
     */
     ...
     *
     * @param plug The ContextPlugin's bundle to stop. Returns true if the bundle was stopped; false, otherwise.
     */
     ...
     *
     * @param plug The ContextPlugin's Bundle to uninstall. Returns true if the Bundle was uninstalled; false, otherwise.
     */
     ...
     *
     * @param originalPlug     The plug-in to update
     * @param originalSettings The existing plug-ins settings (or null, if there are none)
     * @param newPlug          The new plug-in
     * @param listener         The listener to send update progress to
     ...
     *
     * @param plug The plug-in to cancel the installation for (in case of updates, specify the original plug-in).
     ...
     *
     * @param plug      The plug-in whose Bundle we should verify
     * @param bundleURL The url of the Bundle on the file-system
     * @throws Exception
     */
    ...
    private class BundleInstaller {
         ...
         *
         * @param originalPlug     The plug-in to update.
         * @param newPlug          The new plug-in that should replace the originalPlug.
         * @param originalSettings The originalPlug's settings (or null).
         * @param listener         The listener that should receive updates.
         */
         ...
         *
         * @param newPlug  The plug-ins whose Bundle we should install.
         * @param listener The listener that should receive updates.
         */
