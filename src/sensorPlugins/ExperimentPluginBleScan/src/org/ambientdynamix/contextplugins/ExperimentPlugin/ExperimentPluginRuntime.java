...
public class ExperimentPluginRuntime extends ReactiveContextPluginRuntime {
	...
	public void handleContextRequest(UUID requestId, String contextType) {
		...
		try {
			...
			String jsonGpsReading = b.getString("org.ambientdynamix.contextplugins.GpsPlugin");
			String jsonBleReaderScan = b.getString("org.ambientdynamix.contextplugins.BleReaderPlugin");
			List<Reading> readings = new ArrayList<Reading>();
			PluginInfo info = new PluginInfo();
			info.setState("ACTIVE");

			if (jsonGpsReading != null) {
				Log.w("Experiment Message:", jsonGpsReading);
				readings.add(new Reading(Reading.Datatype.String, jsonGpsReading, PluginInfo.CONTEXT_TYPE));
			}
			if (jsonBleReaderScan != null) {
				Log.w("Experiment Message:", jsonBleReaderScan);
				readings.add(new Reading(Reading.Datatype.String, jsonBleReaderScan, PluginInfo.CONTEXT_TYPE));
			}
