<%@ page
        import="org.apache.commons.fileupload.FileItem,org.apache.commons.fileupload.disk.DiskFileItemFactory, org.apache.commons.fileupload.servlet.ServletFileUpload" %>
...
<%
    ...
    String path = jspFilePath.substring(0, jspFilePath.lastIndexOf("/"))+"/experimentRepository/";
